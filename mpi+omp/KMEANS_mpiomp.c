...
*/
        ...
        do{
                ...
                #pragma omp parallel shared(maxDist)
                {
                        ...
                        // notare bene questo for, prima erano due for annidati, ora sono stati collassati in uno solo
                        // con un solo for è più semplice spartire le iterazioni tra i thread, pero con due for è più utile per il false sharing
